...
def dixy(id: str):
    ...
    for json_data in requests.get('https://dixy.ru/ajax/listing-json.php', params=params, headers=headers).json():
        products = json_data["cards"]
        ...
        for product in products:
            ...
            srt_lst.append([float(price), title])
